const color = ['#f9a363', '#8c1346', '#d13d3c', '#e2663b'];

function addHeart() {
  const randomColor = Math.floor(Math.random() * 4);
  const randomX = Math.floor(Math.random() * 100);
  const randomY = Math.floor(Math.random() * 100);
  const svg = `<svg style="top:${randomY}%; left: ${randomX}%;"
    class="heart" version="1.1" xmlns="http://www.w3.org/2000/svg" 
    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" 
    viewBox="0 0 23.217 23.217" style="enable-background:new 0 0 23.217 23.217;" 
    xml:space="preserve"><g><path style="fill:${color[randomColor]};" 
